...
streaming-asset-dependency-graph の作業手順です。
...
- asset は `dist/streaming-asset-dependency-graph-docs.zip`、`docs/manual-test.md`、`docs/strict-manual-test-addendum.md`。
